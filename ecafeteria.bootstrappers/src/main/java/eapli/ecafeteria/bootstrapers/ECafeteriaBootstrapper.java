...
public class ECafeteriaBootstrapper implements Action {
    ...
    public boolean execute() {
        ...
        final Action[] actions = {new MasterUsersBootstrapper(), new BackofficeUsersBootstrapper(), new DishTypesBootstrapper(),
            new CafeteriaUserBootstrapper(), new DishBootstrapper(), new MaterialsBootstrapper(), new HeuristicBootstrapper(), new MenuBootstrapper(),
            new MealBootstrapper(), new BookingBootstrapper(), new LotBootstrapper()};
