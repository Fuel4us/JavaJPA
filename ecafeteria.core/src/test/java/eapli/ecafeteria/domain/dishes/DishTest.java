...
public class DishTest {
    ...
    public void testDishTypeMustNotBeNull() {
        ...
        final Dish instance = new Dish(null, prego, aNutricionalInfo, Money.euros(8), allerg);
    }
    ...
    public void testNameMustNotBeNull() {
        ...
        @SuppressWarnings("unused")
        final Dish instance = new Dish(peixe, null, aNutricionalInfo, Money.euros(5), allerg);
    }
    ...
    public void testNutricionalInfoMustNotBeNull() {
        ...
        @SuppressWarnings("unused")
        final Dish instance = new Dish(peixe, prego, null, Money.euros(7), allerg);
    }
...
//        final Dish instance = new Dish(peixe, prego, aNutricionalInfo, Money.euros(5), allerg);
...
//    }
    ...
    public void ensureCannotChangeNutricionalInfoToNull() {
        ...
        final Dish Dishinstance = new Dish(peixe, prego, new NutricionalInfo(1, 1), Money.euros(7), allerg);
    ...
    public void ensureCannotChangePriceToNegative() {
        ...
        final Dish Dishinstance = new Dish(peixe, prego, new NutricionalInfo(1, 1), Money.euros(1), allerg);
