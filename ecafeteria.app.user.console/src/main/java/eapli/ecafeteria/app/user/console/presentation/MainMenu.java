...
import eapli.ecafeteria.app.user.console.presentation.booking.MealRatingAction;
...
class MainMenu extends CafeteriaUserBaseUI {
    ...
    private Menu buildBookingsMenu() {
        ...
        menu.add(new MenuItem(BOOK_A_MEAL_OPTION, "Book a meal", new MealRatingAction()));
        menu.add(new MenuItem(EXIT_OPTION, "Return ", new ReturnAction()));
        return menu;
    }
